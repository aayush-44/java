...
public class Productcontroller extends HttpServlet {
    ...
    if(action.equalsIgnoreCase("add product"))
    {
        ...
        String savePath = "C:\\Users\\Aayush Patel\\eclipse-workspace\\Myproject1\\src\\main\\webapp\\product_image";
        ...
        file1.write(savePath + java.io.File.separator + fileName);
        String filePath = savePath + java.io.File.separator + fileName ;
        
        String savePath2 = "C:\\Users\\Aayush Patel\\eclipse-workspace\\Myproject1\\src\\main\\webapp\\product_image";
        java.io.File imgSaveDir  = new java.io.File(savePath2);
